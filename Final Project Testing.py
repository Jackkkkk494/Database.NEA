...
def Login():
    ...
    def LoginTab():
        ...
        Login = PhotoImage(file = "LoginGUI.png")
        ...
        CancelButton = PhotoImage(file = "Cancel.png")
...
def SelectTab():
    ...
    def Select_Tab():
        ...
        SGW = PhotoImage(file ="LoginGUI.png")
        label = Label(selectionwindow,image=SGW)
        label.pack(pady=10)
        
        ViewBookings = PhotoImage(file ="ViewBooking.drawio.png")
        button1 = Button(selectionwindow,image = ViewBookings,command = Bookings)
        button1.pack(pady=10)

        DataInsertion = PhotoImage(file="DataInsert.drawio.png")
        ...
        LogoutButton = PhotoImage(file="LogoutButton.png")
